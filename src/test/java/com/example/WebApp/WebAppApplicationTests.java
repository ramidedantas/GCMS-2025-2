...
class WebAppApplicationTests {
    ...
    @Test
    public void shouldReturnClariceFork() throws Exception {
        this.mockMvc.perform(get("/Clarice_fork"))
                .andDo(print()).andExpect(status().isOk())
                .andExpect(content()
                        .string(containsString("Hello, Clarice fork!")));
    }
    ...
    public void shouldReturnMarcosAndre() throws Exception {
        this.mockMvc.perform(get("/marcosandre"))
            ...
            .andExpect(content().string(containsString("Hello, Marcos André! Branch realizado")));
    }
  ...
  @Test
  public void shouldReturnMarcosAndreFork() throws Exception {
      this.mockMvc.perform(get("/marcosandre_fork"))
          .andDo(print()) 
          .andExpect(status().isOk())
          .andExpect(content().string(containsString("Hello, Marcos André FORK!")));
  }
  ...
  public void shouldReturnJuliaBranch() throws Exception {
      this.mockMvc.perform(get("/julia_branch"))
          .andDo(print()) 
          .andExpect(status().isOk())
          .andExpect(content().string(containsString("Hello, Julia BRANCH!!")));
  }

    @Test
  public void shouldReturnMarina() throws Exception {
    ...
    @Test
  public void shouldReturnThais() throws Exception {
    ...
    @Test
  public void shouldReturnMarinaBranch() throws Exception {
  ...
  public void shouldReturnJuliaFork() throws Exception {
      this.mockMvc.perform(get("/julia_fork"))
          .andDo(print()) 
          .andExpect(status().isOk())
          .andExpect(content().string(containsString("Hello, Julia FORK!")));
  }
     
  @Test
  public void shouldReturnSamara() throws Exception {
...
public void greetingDelisTest() throws Exception {
  ...
  @Test
public void greetingDelisTestBranch() throws Exception {
   this.mockMvc.perform(get("/delisbranch"))
        .andExpect(status().isOk())
        .andExpect(content().string("Hello, Deliss Branch!?!?"));
}
}
