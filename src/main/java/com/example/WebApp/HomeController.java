...
public class HomeController {
    ...
    public @ResponseBody String greetingClariceBranch() {
        return "Hello, Clarice Queiroz branch!";
    }

    @RequestMapping("/Clarice_fork")
    public @ResponseBody String greetingClariceFork() {
        return "Hello, Clarice fork!";
    }

    @RequestMapping("/vitor")
    public @ResponseBody String greetingVitor() {
        return "Olá, Vitor!!!";
    }

    @RequestMapping("/branch_wallace_gabriel")
    public @ResponseBody String greetingBranchWallaceGabriel() {
        return "Hello, Wallace Gabriel Branch!";
    }

    @RequestMapping("/fork_wallace_gabriel")
    public @ResponseBody String greetingForkWallaceGabriel() {
    ...
    @RequestMapping("/julia_branch")
    public @ResponseBody String greetingJuliaBranch() {
        return "Hello, Julia BRANCH!!";
    }
    ...
    public @ResponseBody String greetingBranchGabrielDuda() {
    ...
    @RequestMapping("/gabriel_fork")
    public @ResponseBody String greetingGabrielFork() {
        return "Hello, Gabriel FORK!";
    }
